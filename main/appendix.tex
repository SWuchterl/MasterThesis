...
In \refTab{tab:app_MCsets} the DBS paths of the used SM simulated data sets are given together with their cross sections used for the normalization of the processes. In cases where NLO to NNLO k-factors are used, this is also stated in the table.
...
% \FloatBarrier
% \newpage
\section*{Simulated signal data sets}
