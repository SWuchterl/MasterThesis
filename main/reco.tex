...
As already pointed out in \refSec{sec:datasets}, the events are recorded with three lepton combinations of various dilepton triggers. A list of all HLT trigger paths is given in \refTab{}

\begin{table}[H]
 % \begin{table*}[htb]
 \centering
 \caption{\todo{cap}Trigger paths used in the analysis.}
 \normalsize
 \label{tab:trigger}
...
Measuring of the trigger efficiency is essential to obtain appropriate transverse momentum requirements for the dilepton system.
