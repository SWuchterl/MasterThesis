...
In proton proton collisions the initial total momentum of the colliding partons is unknown since they carry only a fraction of the proton energy, but the transverse momentum in the initial state is negligible. Therefore, the transve momentum
\begin{equation}
